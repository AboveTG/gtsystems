export function rhetoricalScan(text = "") {
    ...
    urgency:
        /(urgent|immediately|breaking|act now|today)/g,

    fear:
        /(threat|danger|collapse|crisis|war|risk)/g,

    authority:
        /(experts|officials|scientists|according to)/g,

    certainty:
        /(always|never|undeniable|certainly)/g,

    outrage:
        /(outrage|shocking|scandal|horrific)/g,

    tribalism:
        /(they want|them|us vs|enemy)/g,

    speculation:
        /(could|might|may|possibly)/g
};
